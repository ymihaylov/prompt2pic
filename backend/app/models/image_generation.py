...
class ImageGenerationRequest(BaseModel):
    ...
    prompt: str = Field(..., max_length=300, description="User text prompt input (max 300 characters)")
    gallery_images_count: int = Field(0, ge=0, le=15, description="Number of gallery images to generate (0-15)")
